    ...
    public partial class Initials : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Allergie_Details", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Allergie_Details_Allergies_AllergieId",
                        column: x => x.AllergieId,
                        principalTable: "Allergies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Allergie_Details_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allergie_Details_AllergieId",
                table: "Allergie_Details",
                column: "AllergieId");

            migrationBuilder.CreateIndex(
                name: "IX_Allergie_Details_PatientId",
                table: "Allergie_Details",
                column: "PatientId");
